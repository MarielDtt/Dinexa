...
export default function Footer() {
  return (
    <footer className="w-full bg-text-primary px-4 py-10 flex flex-col gap-6">
      ...
      {/* Copyright + redes + contacto */}
      <div className="w-full flex flex-col items-center gap-4">

        <p className="text-text-inverse text-body-sm text-center opacity-70">
          © 2026 Dinexa.
          <br />
