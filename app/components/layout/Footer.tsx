        ...
        <div className="w-full flex flex-col items-center gap-4 lg:flex-row lg:justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Ir a Facebook de Dinexa"
              className="w-10 h-10 rounded-full border border-text-inverse/25 flex items-center justify-center text-text-inverse/90 hover:text-accent-hover transition-colors duration-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Ir a Instagram de Dinexa"
              className="w-10 h-10 rounded-full border border-text-inverse/25 flex items-center justify-center text-text-inverse/90 hover:text-accent-hover transition-colors duration-200"
            >
              <InstagramIcon fontSize="small" aria-hidden="true" />
            </a>

            <a
              href="mailto:dinexasf@gmail.com"
              aria-label="Enviar correo a Dinexa (dinexasf@gmail.com)"
              className="w-10 h-10 rounded-full border border-text-inverse/25 flex items-center justify-center text-text-inverse/90 hover:text-accent-hover transition-colors duration-200"
            >
            ...
            <a
              ...
              aria-label="Llamar a Dinexa al 11 5472-4032"
              className="w-10 h-10 rounded-full border border-text-inverse/25 flex items-center justify-center text-text-inverse/90 hover:text-accent-hover transition-colors duration-200"
            >
