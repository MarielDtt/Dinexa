...
export default function MenuOverlay({ onClose }: MenuOverlayProps) {
    return (
        <div className="fixed inset-0 z-50 bg-black/40 flex justify-end px-4 pt-13 " onClick={onClose}>
            <div
                className="w-[320px] p-4 rounded-lg border border-border-soft bg-text-primary/90 flex flex-col items-center justify-between h-[418px]"
